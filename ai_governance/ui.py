...
Single-page app (vanilla JS, no build step) that polls /dashboard every 5s.
Side-by-side: normal performance metrics vs governance signals.
"""
...
<footer>Auto-refreshes every 5 s · <a href="/docs" style="color:var(--accent)">API Docs</a> · <a href="/metrics" style="color:var(--accent)">Metrics</a> · <a href="/audit" style="color:var(--accent)">Audit Log</a></footer>
